"""
Django settings for quiet_term_dev_74706 project.
...
ROOT_URLCONF = 'quiet_term_dev_74706.urls'
...
WSGI_APPLICATION = 'quiet_term_dev_74706.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_term_dev_74706 API",
    "DESCRIPTION": "API documentation for quiet_term_dev_74706 App",
    "VERSION": "v1",
}
